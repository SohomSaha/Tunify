...
import { HeadphonesIcon, Loader, Music, Users } from "lucide-react";
            ...
            >
              <div className="flex items-start gap-3">
                <div className="relative">
                  ...
                  <div
                    className="absolute bottom-0 right-0 w-3 h-3 bg-zinc-500 border-2 border-zinc-900 rounded-full"
                    aria-hidden="true"
                  />
                </div>
